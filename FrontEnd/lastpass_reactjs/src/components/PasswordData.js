...
// import { Button, /*Modal,*/ ModalHeader, ModalBody, ModalFooter, CardHeader,CardImg, CardImgOverlay,, Form, FormGroup, Label, Input, } from "reactstrap";
...
const PasswordData = (props) => {
  ...
  if (props.auth.token !== null) {
    console.log(
      "The props inside PasswordData-Component when authentication is successful",
      props
    );
